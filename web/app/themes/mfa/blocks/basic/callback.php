 ...
 */
function mfa_basic_block( $block, $content = '', $is_preview = false ) {
	$context               = Timber::context();
	$context['block']      = $block;
	$context['fields']     = get_fields() ? get_fields() : array();
	$context['is_preview'] = $is_preview;

	$classes = array( 'mfa-block', 'wp-block-mfa-basic' );
	...
	Timber::render( 'blocks/basic.twig', $context );
}
