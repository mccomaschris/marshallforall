 ...
 */
function mfa_footer_block( $block, $content = '', $is_preview = false ) {
	$context               = Timber::context();
	$context['block']      = $block;
	$context['fields']     = get_fields() ? get_fields() : array();
	$context['is_preview'] = $is_preview;

	$classes = array( 'mfa-block', 'wp-block-mfa-footer' );
	...
	Timber::render( 'blocks/footer.twig', $context );
}
